...
public class ContaService {
    ...
    public void realizarTransferencia(Integer numeroOrigem, Integer numeroDestino, BigDecimal valor) {
        this.realizarSaque(numeroOrigem, valor);
        this.realizarDeposito(numeroDestino, valor);
    }
